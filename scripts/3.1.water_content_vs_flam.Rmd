...
tti.top2R <- ggplot(data = both_df1.remef, aes(y = r_tti.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 1.73, label = 'a', size = 12, fontface = 'bold') +
...
fh.top2R <- ggplot(data = both_df1.remef, aes(y = r_fh.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 2.89, label = 'e', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
fd.top2R <- ggplot(data = both_df1.remef, aes(y = r_fd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.29, label = 'f', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
gd.top2R <- ggplot(data = both_df1.remef, aes(y = r_gd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.3, label = 'g', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
temp.top2R <- ggplot(data = both_df1.remef, aes(y = r_temp.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3.65, label = 'b', size = 12, fontface = 'bold') +
...
pfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_pfg.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.865, label = 'h', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
ttfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_ttfg.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 2.37, label = 'c', size = 12, fontface = 'bold') +
  guides(color = guide_legend(override.aes = list(size = 1.6))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
 theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
...
gti.top2R <- ggplot(data = both_df1.remef, aes(y = r_gti.top2, x = mpa, color = Model)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.6))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
  annotate('text', x = -9.5, y = 2.705, label = 'd', size = 12, fontface = 'bold') +
 theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
2 columns (Figure 3)
```{r}
mpa.plots <- ggarrange(tti.top2R, temp.top2R, ttfg.top2R, gti.top2R, ncol = 1, nrow = 4, legend = 'none')
mpa.plots.grob <-ggarrange(arrangeGrob(mpa.plots, bottom = mpa.grob))

dw.plots <- ggarrange(fh.top2R, fd.top2R, gd.top2R, pfg.top2R, ncol = 1, nrow = 4)
dw.plots.grob <- ggarrange(arrangeGrob(dw.plots, bottom = dw.grob))

plots <- ggarrange(mpa.plots.grob, dw.plots.grob, nrow = 1)

legend <- get_legend(gti.top2R)

plots.legend <- cowplot::plot_grid(plots, legend, ncol = 2, rel_widths = c(4.5, 1))
plots.legend
ggsave(here("figures/Fig3.hydration.vs.metrics.MEM.selection.r.jpg"), height = 14, width = 12)
```
