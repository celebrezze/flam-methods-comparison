...
tti.lfmR <- ggplot(data = both_df1.remef, aes(y = r_tti, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 3.2, label = 'a', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
...
fh.lfmR <- ggplot(data = both_df1.remef, aes(y = r_fh, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 1.3, label = 'b', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
fd.lfmR <- ggplot(data = both_df1.remef, aes(y = r_fd, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 3.125, label = 'c', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
gd.lfmR <- ggplot(data = both_df1.remef, aes(y = r_gd, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 2.425, label = 'd', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
temp_max.lfmR <- ggplot(data = both_df1.remef, aes(y = r_temp_max, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 3.1, label = 'e', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
pfg.lfmR <- ggplot(data = both_df1.remef, aes(y = r_pfg, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 2.4, label = 'f', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
ttfg.lfmR <- ggplot(data = both_df1.remef, aes(y = r_ttfg, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 3.1, label = 'g', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
gti.lfmR <- ggplot(data = both_df1.remef, aes(y = r_gti, x = lfm_outliers_out, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = 40, y = 3.375, label = 'h', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
tti.mpaR <- ggplot(data = both_df1.remef, aes(y = r_tti.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 1.9, label = 'a', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
fh.mpaR <- ggplot(data = both_df1.remef, aes(y = r_fh.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3, label = 'b', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
fd.mpaR <- ggplot(data = both_df1.remef, aes(y = r_fd.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3.27, label = 'c', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
gd.mpaR <- ggplot(data = both_df1.remef, aes(y = r_gd.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3.2, label = 'd', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14), 
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
temp.mpaR <- ggplot(data = both_df1.remef, aes(y = r_temp.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 4.05, label = 'e', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14), 
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
pfg.mpaR <- ggplot(data = both_df1.remef, aes(y = r_pfg.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 4, label = 'f', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
ttfg.mpaR <- ggplot(data = both_df1.remef, aes(y = r_ttfg.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 2.45, label = 'g', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
gti.mpaR <- ggplot(data = both_df1.remef, aes(y = r_gti.w, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 2.75, label = 'h', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
ggsave(here("figures/FigS4.mpa.vs.metrics.MEM.REMEF.jpg"), height = 10, width = 10)
```
...
tti.dwR <- ggplot(data = both_df1.remef, aes(y = r_tti.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 2.4, label = 'a', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
fh.dwR <- ggplot(data = both_df1.remef, aes(y = r_fh.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3, label = 'b', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
fd.dwR <- ggplot(data = both_df1.remef, aes(y = r_fd.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3.35, label = 'c', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
gd.dwR <- ggplot(data = both_df1.remef, aes(y = r_gd.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3.35, label = 'd', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14), 
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
temp.dwR <- ggplot(data = both_df1.remef, aes(y = r_temp.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3.85, label = 'e', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14), 
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank(),
...
pfg.dwR <- ggplot(data = both_df1.remef, aes(y = r_pfg.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3.9, label = 'f', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
ttfg.dwR <- ggplot(data = both_df1.remef, aes(y = r_ttfg.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 2.7, label = 'g', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
gti.dwR <- ggplot(data = both_df1.remef, aes(y = r_gti.dw, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.8, y = 3.15, label = 'h', size = 10, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold'),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        axis.title.x = element_blank())
...
ggsave(here("figures/FigS5.dw.vs.metrics.MEM.REMEF.jpg"), height = 10, width = 10)
```
...
tti.top2R <- ggplot(data = both_df1.remef, aes(y = r_tti.top2, x = mpa, color = Model)) +
  geom_point(size = 2.1, alpha = 0.7, aes(shape = Species)) +
  geom_smooth(method = "lm", se = F) +
  labs(y ="Time to Ignition", x = "Water Potential (MPa)", color = "Method", shape = "Species") +
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 1.73, label = 'e', size = 12, fontface = 'bold') +
...
fh.top2R <- ggplot(data = both_df1.remef, aes(y = r_fh.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 2.89, label = 'a', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
fd.top2R <- ggplot(data = both_df1.remef, aes(y = r_fd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.29, label = 'b', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
gd.top2R <- ggplot(data = both_df1.remef, aes(y = r_gd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.3, label = 'c', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
temp.top2R <- ggplot(data = both_df1.remef, aes(y = r_temp.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3.65, label = 'f', size = 12, fontface = 'bold') +
...
pfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_pfg.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.865, label = 'd', size = 12, fontface = 'bold') +
  theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
ttfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_ttfg.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 2.37, label = 'g', size = 12, fontface = 'bold') +
  guides(color = guide_legend(override.aes = list(size = 1.6))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
 theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
...
gti.top2R <- ggplot(data = both_df1.remef, aes(y = r_gti.top2, x = mpa, color = Model)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.6))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
  annotate('text', x = -9.5, y = 2.705, label = '-', size = 12, fontface = 'bold') +
 theme(axis.title = element_text(face = 'bold', size = 18),
        axis.text = element_text(size = 16),
        legend.title = element_text(face = 'bold', size = 18),
        legend.text = element_text(face = 'italic', size = 16),
...
2 columns (Figure 3)
```{r}
legend <- get_legend(gti.top2R)

mpa.plots <- cowplot::plot_grid(tti.top2R, temp.top2R, ttfg.top2R, ncol = 1, nrow = 3)
mpa.plots.grob <-ggarrange(arrangeGrob(mpa.plots, bottom = mpa.grob))
mpa.plots.leg <- cowplot::plot_grid(mpa.plots.grob, legend, ncol = 1, nrow = 2, rel_heights = c(3, 1))

dw.plots <- cowplot::plot_grid(fh.top2R, fd.top2R, gd.top2R, pfg.top2R, ncol = 1, nrow = 4)
dw.plots.grob <- ggarrange(arrangeGrob(dw.plots, bottom = dw.grob))

plots <- ggarrange(dw.plots.grob, mpa.plots.leg, nrow = 1)

ggsave(here("figures/Fig3.hydration.vs.metrics.MEM.selection.r.jpg"), height = 14, width = 10)
```

4 columns (old version of fig. 3)
```{r}
...
#ggsave(here("figures/Fig3.hydration.vs.metrics.MEM.selection.r.jpg"), height = 8.5, width = 14)
```
