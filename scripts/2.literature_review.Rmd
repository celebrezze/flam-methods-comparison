...
epi.studies <- '[5,6],[16,17],[24],[30],[32],[42],[57],[63-86],[15,18,31,33,34]*'
grill.studies <- '[9],[87-99]'
mf.studies <- '[7],[43],[52,53],[95],[100-106]'
cc.studies <- '[108]*,[109-116],[45,117]**'
mlc.studies <- '[8],[10,11],[44],[56],[63],[118-121]'
ob.studies <- '[6-8],[10],[57],[71],[75],[85],[122,123]'
sr.studies <- '[124-132]'
wt.studies <- '[10,11],[47],[54],[133-137]'
fb.studies <- '[17],[51],[120],[138-143]'
xl.studies <- '[20],[144-149]'
direct.flame.studies <- '[19],[122,123],[127],[150,151]'
tray.studies <- '[24],[134],[152-155]'
fpa.studies <- '[156-159]'
ffb.studies <- '[14],[55],[160,161]'
isc.studies <- '[50],[111]'
other.studies <- '(1) [162];(2) [155];(3) [163];(4) [45];(5) [24];(6) [164]'
