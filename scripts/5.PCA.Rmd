...
ggsave(here('figures/FigS6.PCAflammetrics.jpg'), height = 8, width = 12)
```
...
ggsave(here('figures/Fig4.pca.sidebyside.jpg'), plot = PCA.epi.and.hp, height = 7.5, width = 16.5)
```
...
ggsave(here('figures/FigS7.PCAflammetrics.scaled.centered.jpg'), height = 8, width = 12)
```
