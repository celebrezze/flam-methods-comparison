...
## Flame Height (not scaled and centered)
```{r}
...
## Flame Height (scaled and centered)
```{r}
...
# Time to Ignition vs. Water Status (more in-depth)
...
## Water Potential vs. Time to Ignition (Not Scaled, Centered)
```{r}
...
## Water Potential vs. Time to Ignition (scaled, centered)
```{r}
...
ggsave("figures/lfm.vs.metrics.MEM.jpg", height = 10, width = 10)
```
...
ggsave("figures/mpa.vs.metrics.MEM.jpg", height = 10, width = 10)
```
...
ggsave("figures/dw.vs.metrics.MEM.jpg", height = 10, width = 10)
```
...
ggsave("figures/lfm.vs.metrics.MEM.REMEF.jpg", height = 10, width = 10)
```
...
ggsave("figures/mpa.vs.metrics.MEM.REMEF.jpg", height = 10, width = 10)
```
...
ggsave("figures/dw.vs.metrics.MEM.REMEF.jpg", height = 10, width = 10)
```
...
ggsave("figures/hydration.vs.metrics.MEM.split.selection.remef.jpg", height = 10, width = 10)
```
...
tti.top2R <- ggplot(data = both_df1.remef, aes(y = r_tti.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 1.73, label = 'a', size = 11) +
...
fh.top2R <- ggplot(data = both_df1.remef, aes(y = r_fh.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 2.89, label = 'e', size = 11) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
...
fd.top2R <- ggplot(data = both_df1.remef, aes(y = r_fd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.29, label = 'f', size = 11) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        legend.position = 'none',
...
gd.top2R <- ggplot(data = both_df1.remef, aes(y = r_gd.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.3, label = 'g', size = 11) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 14), 
        legend.text = element_text(face = 'italic', size = 12),
        legend.position = 'none',
...
temp.top2R <- ggplot(data = both_df1.remef, aes(y = r_temp.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 3.65, label = 'b', size = 11) +
  guides(color = guide_legend(override.aes = list(size = 1.2))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 16), 
...
pfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_pfg.top2, x = dw_scaled, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -2.7, y = 3.865, label = 'h', size = 11) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 14),
        legend.text = element_text(face = 'italic', size = 12),
        legend.position = 'none',
...
ttfg.top2R <- ggplot(data = both_df1.remef, aes(y = r_ttfg.top2, x = mpa, color = Model)) +
  ...
  theme_bw()+
  scale_color_manual(values = c("grey70", "black")) +
  annotate('text', x = -9.5, y = 2.37, label = 'c', size = 11) +
  guides(color = guide_legend(override.aes = list(size = 1.2))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 16),
...
gti.top2R <- ggplot(data = both_df1.remef, aes(y = r_gti.top2, x = mpa, color = Model)) +
  ...
  guides(color = guide_legend(override.aes = list(size = 1.2))) +
  guides(shape = guide_legend(override.aes = list(size = 2))) +
  annotate('text', x = -9.5, y = 2.705, label = 'd', size = 11) +
  theme(axis.title = element_text(face = 'bold', size = 14),
        legend.title = element_text(face = 'bold', size = 16),
        legend.text = element_text(face = 'italic', size = 14),
        axis.title.x = element_blank())
...
ggsave("figures/hydration.vs.metrics.MEM.selection.r.jpg", height = 7, width = 13)
```
