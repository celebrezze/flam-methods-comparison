...
This .Rmd file covers the necessary metadata for the datasets that we used in the analyses for the paper, *A comparison of a novel hot-plate-based flammability chamber design and an epiradiator-based design*.
...
**January 30, 2023** by **Joe Celebrezze**
