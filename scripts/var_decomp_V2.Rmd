---
title: "Variance Decomposition (V2)"
...
ggsave("figures/R2.comparison.scatterplot.jpg", height = 7, width = 10)
```
...
ggsave("figures/vardecomp.barplot.jpg", height = 6, width = 17)
```
...
ggsave('figures/MEM.visualization.vardecomp.jpg', plot = plots, width = 10, height = 4)
```
