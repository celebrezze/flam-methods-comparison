...
col2 <- c('MPa*** + DW* x species', ' ', ' ', 'DW x species', 'WW x species', ' ', 'MPa + DW x species', 'DW x species', 'MPa + LFM + DW x species', 'DW x species','LFM + DW x species', 'MPa*** + LFM* + DW* x species', 'MPa** + DW x species', 'MPa** + [DW x species]*', 'MPa*** + LFM + [DW x species]**', 'LFM + [DW x species]*', 'MPa + DW x species', ' ', '[WW*** x species]**')
