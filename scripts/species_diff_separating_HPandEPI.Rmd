...
ggsave("figures/dw.species.plot.REMEF.jpg", plot = main.dw.plotR, height = 11, width = 7)
```
...
ggsave("figures/lfm.species.plot.REMEF.jpg", plot = main.lfm.plotR, height = 11, width = 7)
```
...
ggsave("figures/mpa.species.plot.REMEF.jpg", plot = main.mpa.plotR, height = 11, width = 7)
```
...
ggsave('figures/species.differences.boxplot.jpg', height = 7, width = 11)
```
...
ggsave('figures/species.differences.boxplot.rawmetrics.jpg', height = 7, width = 11)
```
...
ggsave("figures/top.models.species.plot.REMEF.jpg", plot = main.plotR, height = 10, width = 7)
```
